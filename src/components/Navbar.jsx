...
const Navbar = () => {
    ...
    return (
        <div><div className="flex justify-between items-center px-10 py-5 bg-zinc-900 border-b border-zinc-800">
            ...
            <div className="flex gap-4">
                <button className="text-white text-lg bg-zinc-800 px-4 py-2 rounded-lg hover:bg-zinc-700 transition-all flex items-center gap-3"><Share2 />Share</button>
