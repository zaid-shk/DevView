...
const Navbar = () => {
    ...
    return (
        <div className={clsx(
            ...
            theme === 'light' ? "bg-white/80 backdrop-blur-md border-zinc-200" : "bg-[#0a0a0a]/80 backdrop-blur-md border-zinc-800/50"
        )}>
            <div className="flex justify-between items-center px-6 lg:px-10 py-3 max-w-[1600px] mx-auto">
