  ...
  return (
    <div className="relative min-h-[90vh] flex flex-col lg:flex-row items-center justify-between px-10 lg:px-20 py-20 overflow-hidden bg-zinc-950">
      ...
      <div className="z-10 max-w-2xl text-center lg:text-left">
        ...
        {/* Headline */}
        <h1 className="text-5xl lg:text-[4vw] font-bold text-white tracking-wide leading-[1.1] mb-8">
          Preview Your <br />
          Website Across <br />
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-8">
          <button className="w-full sm:w-auto px-8 py-4  text-zinc-950 font-bold rounded-xl transition-all flex items-center justify-center gap-2 bg-blue-600 px-4 py-2 rounded-lg hover:bg-blue-500 transition-all shadow-lg shadow-blue-500/20">
            Start Preview
